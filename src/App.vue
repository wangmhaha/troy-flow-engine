 ...
 * @LastEditors: wangmin
 * @LastEditTime: 2025-05-20 11:28:55
 -->
<template>
  <div class="container">
    <TroyFlowEngine
  ...
  const data = await new Promise((resolve) => {
    setTimeout(() => {
      resolve([
        {
          createBy: "admin",
          createTime: "2025-04-30 15:35:52",
          updateBy: "admin",
          updateTime: "2025-05-14 16:32:00",
          remark: "1111",
          id: 1,
          code: "1231213",
          name: "发起请假流程表单",
          formJson:
            '[{"info": "", "name": "ref_Fpzamann3151amc", "type": "timePicker", "field": "time", "props": {"isRange": true}, "title": "请假时间", "_fc_id": "id_F0crmann3151alc", "hidden": false, "display": true, "$required": "请输入请假时间", "_fc_drag_tag": "timeRange"}, {"info": "", "name": "ref_Fkatmann3kviapc", "type": "input", "field": "reson", "props": {"type": "textarea"}, "title": "请假理由", "_fc_id": "id_F8b2mann3kviaoc", "hidden": false, "display": true, "$required": "请输入请假理由", "_fc_drag_tag": "textarea"}]',
          optionJson:
            '{"form": {"size": "default", "inline": false, "labelWidth": "125px", "labelPosition": "right", "hideRequiredAsterisk": false}, "resetBtn": {"show": false, "innerText": "重置"}, "submitBtn": {"show": true, "innerText": "提交"}}',
          delFlag: "0",
        },
      ]);
    }, 1000);
